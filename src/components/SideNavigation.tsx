        ...
        <NavigationMenu>
          <NavigationMenuList className="w-full h-full flex-col flex gap-3 py-5">
            ...
            <NavigationMenuItem
              ...
              onClick={() => setExtraNavbarOpen("closed")}
            >
              <Link href={"/currency"} legacyBehavior passHref>
                <NavigationMenuLink
                  iconLeading={
            ...
            >
              <Link href={"/fiscal-year"} legacyBehavior passHref>
                <NavigationMenuLink
                  iconLeading={<CalendarBlank size={16} weight={"fill"} />}
                  type={"filled"}
                  className="w-full bg-[#313441]"
                >
                  Fiscal Year
          ...
          >
            ...
            <div className="w-full flex justify-center px-3 py-3">
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    iconLeading={<Lightning size={16} weight={"fill"} />}
                    emphasis="high"
                    color="primary"
                    size="md"
            ...
            <NavigationMenuItem className={"px-3"}>
              <NavigationMenuLink
                ...
                selected={
                  extraNavbarOpen === "setup" || path === "/fiscal-calendar"
                }
              >
                {!collapsed && "Setup"}
              </NavigationMenuLink>
            ...
            <NavigationMenuItem className={"px-3"}>
              <NavigationMenuLink
                ...
                iconTrailing={<CaretRight size={16} weight={"bold"} />}
                iconLeading={<CurrencyDollar size={16} weight={"fill"} />}
                type={"filled"}
                className={collapsed ? "" : "w-full"}
              >
