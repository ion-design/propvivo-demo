// ion/Button: Generated with Ion on 3/3/2024, 2:11:40 PM
...
export const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      emphasis: {
        gradient: "disabled:bg-soft disabled:text-soft-foreground border-none",
    ...
    compoundVariants: [
      ...(["primary", "secondary", "danger"] as const).flatMap((color) =>
        [
          {
...
export type ButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  ...
  emphasis?: "high" | "medium" | "low" | "gradient" | "link";
  size?: "sm" | "md" | "lg";
};
