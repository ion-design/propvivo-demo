"use client";
// ion/SideNavigationItem: Generated with Ion on 3/3/2024, 2:11:39 PM
...
const navigationMenuLinkClassnames = cva(
   "flex cursor-default justify-between whitespace-nowrap shrink-0 items-center gap-2 rounded-radius border-transparent px-3 py-2 text-base no-underline outline-none transition-colors",
   {
      variants: {
         type: {
            filled:
