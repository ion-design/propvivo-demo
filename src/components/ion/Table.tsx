"use client";
// ion/TableContainer: Generated with Ion on 3/3/2024, 6:32:45 PM
...
>(({ className, ...props }, ref) => (
   <thead
      ref={ref}
      className={clsx(
         "whitespace-nowrap border-soft-stroke bg-weak [&>tr]:border-b-0",
         className
      )}
      {...props}
   />
...
>(({ className, ...props }, ref) => (
   <tfoot
      ref={ref}
      className={clsx("border-t border-soft-stroke font-medium", className)}
      {...props}
   />
));
...
export default function Table<TData, TValue>({
   ...
   return (
      ...
      >
         <TableRoot
            className={
               "w-full max-w-full" + bordered ? "border" : ""
            }
         >
